                ...
                <div class="containerBtnsActions">
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ferragro@latest/assets/step3.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ferragro@latest/assets/step4.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ferragro@latest/assets/step2.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/ferragro@latest/assets/step1.webp">
                                </div>
...
setTimeout(()=>{
    mudiExperience.experienceOn( document.body.querySelector('[name="contact[sku]"]').value , document.body.querySelector('.product-gallery') )
},3000)
